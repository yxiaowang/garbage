...
public interface GarbageCategoryMapper {
    ...
    List<GarbageCategory> selectByExampleWithBLOBs(GarbageCategoryExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") GarbageCategory record, @Param("example") GarbageCategoryExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(GarbageCategory record);
