...
<table class="easyui-datagrid" id="catList" title="分类目录列表"
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/cat/list',method:'get',pageSize:30,toolbar:toolbar">
    <%--这个是请求的url，自带page和rows参数--%>
    <%--请求的url：http://localhost:8080/item/list?page=1&rows=30 --%>
    <thead>
    <tr>
        <th data-options="field:'ck',checkbox:true"></th>
        <th data-options="field:'id',width:60">分类目录ID</th>
        <th data-options="field:'nameCn',width:200">中文名称</th>
        <th data-options="field:'nameEn',width:200">英文名称</th>
        <th data-options="field:'parentId',width:100">父目录ID</th>
        <th data-options="field:'catDesc',width:100">详细信息</th>
        <th data-options="field:'logo',width:100">logo</th>
        <th data-options="field:'catStatus',width:60,align:'center',formatter:TAOTAO.formatItemStatus">状态</th>
