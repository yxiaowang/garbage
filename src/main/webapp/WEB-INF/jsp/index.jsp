    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02"
                 style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(/images/garbage.jpeg) 0px 0px no-repeat;">
            </div>
            <div class="form ">
                ...
                <div class="item login-btn2013">
                    <input type="button" class="btn-img" id="loginsubmit" value="登录" tabindex="8"
        ...
        <div class="free-regist">
            <span><a href="/user/register" clstag="passport|keycount|login|08">注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<script type="text/javascript">
